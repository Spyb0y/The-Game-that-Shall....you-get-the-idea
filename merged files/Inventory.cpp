...
void Inventory::CreateEnemyVectors()
{
	...
	Enemy* mRat = new Rat();
	Enemy* mPheasant = new Pheasent();
	Enemy* mArmouredPhesant = new ArmoredPhesant();
	...
	//Enemy* mStalker = new Stalker()//boss 6

	//push the pointers into the correct arrays
	//castle vector
	CastleEnemies.push_back(mRat);
	CastleEnemies.push_back(mPheasant);
	CastleEnemies.push_back(mArmouredPhesant);
