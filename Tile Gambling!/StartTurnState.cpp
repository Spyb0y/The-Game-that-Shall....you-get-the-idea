...
void StartTurnState::Update(ID3D11Device* device, float dt)
{
	
}

void StartTurnState::Draw(CXMMATRIX vp, ID3D11DeviceContext* context, LitTexEffect* litTexEffect)
{
	//nothing to see here....>:/
}

void StartTurnState::DealCard(ID3D11Device* device)
{
